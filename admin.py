...
def admin_app(model, data, headcount):
    ...
    fig.add_scatter(x=[end_date, end_date], y=[180,240], name="Heavy load", line=dict(color="Red"))
    fig.add_scatter(x=[end_date, end_date], y=[240,302], name="Full house", line=dict(color="Black"))
